/**
 * Select component — Radix UI Select, restyled with fantasy theme.
 *
 * Visual style ported from src/index.css select rules and
 * src/App.css .settings-select styling.
 */
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      "rounded-[4px] py-2 pl-8 pr-2",
      "text-[var(--text)] text-sm",
      "outline-none",
      "focus:bg-[var(--shadow)] focus:text-[var(--primary)]",
