            ...
            milestones: [
                {
                    ...
                    type: 'item',
                    requires: [],
                    trigger: { item: 'goblin_scouts_map', action: 'acquire' },
                    spawn: { type: 'item', id: 'goblin_scouts_map', name: 'Goblin Scout\'s Map', location: 'Willowdale' },
            ...
            milestones: [
                {
                    ...
                    spawn: { type: 'item', id: 'hidden_map', name: 'Hidden Map', location: 'Millhaven' },
            ...
            milestones: [
                {
                    ...
                    type: 'item',
                    requires: [],
                    trigger: { item: 'caravan_ledger', action: 'acquire' },
                    spawn: { type: 'item', id: 'caravan_ledger', name: 'Caravan Ledger', location: 'Sandreach' },
                ...
                },
                {
                    ...
                    type: 'talk',
                    requires: [],
                    trigger: { npc: 'well_keeper', action: 'talk' },
            ...
            milestones: [
                {
                    ...
                    type: 'item',
                    requires: [],
                    trigger: { item: 'sun_kings_star_chart', action: 'acquire' },
                    spawn: { type: 'item', id: 'sun_kings_star_chart', name: 'Sun-Kings\' Star-Chart', location: 'Dustmere' },
            ...
            milestones: [
                {
                    ...
                    type: 'item',
                    requires: [],
                    trigger: { item: 'frostbound_ledger', action: 'acquire' },
                    spawn: { type: 'item', id: 'frostbound_ledger', name: 'Frostbound Ledger', location: 'Hearthmere' },
            ...
            milestones: [
                {
                    ...
                    type: 'item',
                    requires: [],
                    trigger: { item: 'famine_winter_saga', action: 'acquire' },
                    spawn: { type: 'item', id: 'famine_winter_saga', name: 'The Famine-Winter Saga', location: 'Icemoor' },
            ...
            milestones: [
                {
                    ...
                    type: 'item',
                    requires: [],
                    trigger: { item: 'moorland_herbs', action: 'acquire' },
                    spawn: { type: 'item', id: 'moorland_herbs', name: 'Moorland Herbs', location: 'Grey Moors' },
                    building: null,
            ...
            milestones: [
                {
                    ...
                    type: 'item',
                    requires: [],
                    trigger: { item: 'automaton_control_rod', action: 'acquire' },
                    spawn: { type: 'item', id: 'automaton_control_rod', name: 'Automaton Control Rod', location: 'Tinker-Row' },
        ...
        settings: {
            ...
            milestones: [
                ...
                },
                {
                    ...
                    type: 'item',
                    requires: [],
                    trigger: { item: 'stolen_aether_blueprints', action: 'acquire' },
                    spawn: { type: 'item', id: 'stolen_aether_blueprints', name: 'Stolen Aether Blueprints', location: 'Aether-Gate' },
                ...
                },
                {
                    ...
                    type: 'talk',
                    requires: [1, 2],
                    trigger: { npc: 'oracle_of_steam', action: 'talk' },
            ...
            milestones: [
                {
                    ...
                    type: 'item',
                    requires: [],
                    trigger: { item: 'cult_journal', action: 'acquire' },
                    spawn: { type: 'item', id: 'cult_journal', name: 'Cult Journal', location: 'Hollowmarsh' },
            ...
            milestones: [
                {
                    ...
                    type: 'item',
                    requires: [],
                    trigger: { item: 'forbidden_ritual_text', action: 'acquire' },
                    spawn: { type: 'item', id: 'forbidden_ritual_text', name: 'Forbidden Ritual Text', location: 'Blackwood' },
