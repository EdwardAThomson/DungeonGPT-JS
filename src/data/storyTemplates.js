export const storyTemplates = [
    {
        ...
        settings: {
            ...
            milestones: [
                { text: 'Find the hidden map in the archives of Oakhaven.', location: 'Oakhaven' },
                { text: 'Convince the Silver Guard to join the resistance.', location: 'Silverton' },
                { text: 'Locate the Sunfire Vault deep within the Cinder Mountains.', location: 'Cinder Mountains' }
            ],
            grimnessLevel: 'Noble',
    ...
    },
    {
        ...
        settings: {
            ...
            milestones: [
                { text: 'Establish a fortified camp in the ruins of Ironhold.', location: 'Ironhold' },
                { text: 'Capture a mutated specimen for the alchemist at Pale-Reach.', location: 'Pale-Reach' },
                { text: 'Destroy the Rot-Heart growing in the depths of Rotfall.', location: 'Rotfall' }
            ],
            grimnessLevel: 'Grim',
            darknessLevel: 'Dark',
    ...
    },
    {
        ...
        settings: {
            ...
            milestones: [
                { text: 'Investigate the explosion at the Cog-Hill foundry.', location: 'Cog-Hill' },
                { text: 'Retrieve the stolen blueprints from the Aether-Gate syndicate.', location: 'Aether-Gate' },
                { text: 'Consult the Oracle of Steam in the depths of the Steam-Wharf.', location: 'Steam-Wharf' }
            ],
    ...
    },
    {
        ...
        settings: {
            ...
            milestones: [
                { text: 'Decode the ritual text found in the Blackwood library.', location: 'Blackwood' },
                { text: 'Cleanse the corrupted lighthouse at Whisper-Cove.', location: 'Whisper-Cove' },
                { text: 'Survive a vision of the Void at the summit of Mourn-Peak.', location: 'Mourn-Peak' }
            ],
            grimnessLevel: 'Bleak',
            darknessLevel: 'Dark',
            magicLevel: 'Low Magic',
