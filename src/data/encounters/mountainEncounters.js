...
export const MOUNTAIN_ENCOUNTERS = {
  ...
  'mountain_dragon': {
    ...
    // runed_greatsword (#44): second drop path for the obtainable +2 weapon (very_rare,
    // same tier gate) — a hero's blade from the bottom of a dragon hoard.
    rewards: { xp: 200, gold: '20d20', items: ['dragon_scale:80%', 'dragon_gold:90%', 'legendary_artifact:25%', 'dragon_egg:5%', 'dragonscale_plate:20%', 'runed_greatsword:15%'] },
    consequences: {
