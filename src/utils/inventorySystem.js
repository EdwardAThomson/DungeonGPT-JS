...
export const ITEM_CATALOG = {
  ...
  'bell_of_the_last_tide': { name: 'Bell of the Last Tide', rarity: 'very_rare', value: 8000, type: 'artifact', bonus: '+3', description: 'A hand-bell cast from the Bell-Warden\'s bronze heart. Rung once, the tide about the bearer forgets, for a breath, which way it was going.', icon: 'assets/icons/items/ancient_artifact.webp' }, // #70: The Drowned Bells finale reward; bespoke icon queued in IMAGE_GENERATION_PROMPTS, borrowing ancient_artifact until it lands
