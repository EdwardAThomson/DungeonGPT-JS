...
export const ITEM_CATALOG = {
  ...
  'enchanted_trinket': { name: 'Enchanted Trinket', rarity: 'uncommon', value: 65 },
  'ghostly_trinket': { name: 'Ghostly Trinket', rarity: 'uncommon', value: 60 },
  'history_tome': { name: 'Ancient History Tome', rarity: 'uncommon', value: 150 },
  'forbidden_knowledge': { name: 'Forbidden Knowledge', rarity: 'rare', value: 300 },
  'spirit_essence': { name: 'Spirit Essence', rarity: 'rare', value: 120 },
  'primal_essence': { name: 'Primal Essence', rarity: 'rare', value: 150 },
  'journal_page': { name: 'Torn Journal Page', rarity: 'common', value: 5 },
  ...
  'mountain_herbs': { name: 'Mountain Herbs', rarity: 'common', value: 15 },
  ...
  'elven_rations': { name: 'Elven Waybread', rarity: 'uncommon', value: 20, stackable: true },
  'nature_blessing': { name: 'Nature\'s Blessing', rarity: 'rare', value: 0, type: 'blessing' },
  'elven_blessing': { name: 'Elven Blessing', rarity: 'rare', value: 0, type: 'blessing' },
  'eagle_blessing': { name: 'Eagle\'s Blessing', rarity: 'rare', value: 0, type: 'blessing' },
  'druid_token': { name: 'Druid Token', rarity: 'uncommon', value: 50 },
  'nature_charm': { name: 'Nature Charm', rarity: 'uncommon', value: 75 },
  'ancient_gold': { name: 'Ancient Gold Coins', rarity: 'uncommon', value: 100 },
  'pixie_gold': { name: 'Pixie Gold', rarity: 'uncommon', value: 50 },
  'rare_gem': { name: 'Rare Gemstone', rarity: 'rare', value: 200 },
  'drowned_treasure': { name: 'Drowned Treasure', rarity: 'uncommon', value: 75 },
  'cult_treasure': { name: 'Cultist Treasure', rarity: 'uncommon', value: 80 },
  'fallen_treasure': { name: 'Fallen Treasure', rarity: 'uncommon', value: 50 },
  'dragon_gold': { name: 'Dragon Hoard Gold', rarity: 'rare', value: 500 },
  'dragon_egg': { name: 'Dragon Egg', rarity: 'legendary', value: 5000 },
  'cave_map': { name: 'Rough Cave Map', rarity: 'uncommon', value: 30 },
  ...
  'hermit_wisdom': { name: 'Hermit\'s Wisdom', rarity: 'uncommon', value: 100 },
  'ancient_artifact': { name: 'Ancient Artifact', rarity: 'rare', value: 400 },
  'enchanted_seed': { name: 'Enchanted Seed', rarity: 'uncommon', value: 40 },
  'enchanted_mushroom': { name: 'Enchanted Mushroom', rarity: 'uncommon', value: 30 },
