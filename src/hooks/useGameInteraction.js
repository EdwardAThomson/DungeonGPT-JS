...
const useGameInteraction = (
    ...
    const handleStartAdventure = async () => {
        ...
        const scenePrompt = `[ADVENTURE START - SCENE]\n\n[CONTEXT]\n${sceneContext}\n\n[TASK]\nDescribe the arrival of the party and the immediate atmosphere of THIS location only. Describe ONLY the location, buildings, and people named in the context above. Do not name, place, or invent any building or NPC that is not listed here, and do not reference other towns as if they are part of this scene. If no people are listed in the context, you may include at most an anonymous, incidental figure for atmosphere, but such a figure must not be named and must not mention any objective, quest, ledger, destination, or where the party should go next. Begin your response directly with the narrative description.`;
