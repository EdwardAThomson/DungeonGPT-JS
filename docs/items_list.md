...
| # | Key | Name | Rarity | Image Status |
|---|-----|------|--------|--------------|
| 1 | healing_potion | Healing Potion | common | HAS IMAGE |
| 2 | antidote | Antidote | common | HAS IMAGE |
| 3 | rations | Trail Rations | common | HAS IMAGE |
| 4 | torch | Torch | common | HAS IMAGE |
| 5 | rope | Rope (50ft) | common | HAS IMAGE |
| 6 | greater_healing_potion | Greater Healing Potion | uncommon | HAS IMAGE |
| 7 | scroll_fireball | Fire Scroll | uncommon | HAS IMAGE |
| 8 | silver_dagger | Silver Dagger | uncommon | HAS IMAGE |
| 9 | magic_weapon | Enchanted Blade | rare | HAS IMAGE |
| 10 | ring_protection | Protective Ring | rare | HAS IMAGE |
| 11 | legendary_weapon | Legendary Weapon | very_rare | HAS IMAGE |
| 12 | legendary_artifact | Ancient Artifact | very_rare | HAS IMAGE |
| 13 | magic_item | Magic Item | uncommon | HAS IMAGE (uses spell_scroll.webp) |
| 14 | magic_scroll | Enchanted Scroll | uncommon | HAS IMAGE (uses spell_scroll.webp) |
| 15 | cave_mushrooms | Glowing Cave Mushrooms | common | HAS IMAGE |
| 16 | raw_gems | Raw Gemstones | uncommon | HAS IMAGE |
| 17 | dryad_blessing | Dryad's Blessing | rare | HAS IMAGE |
| 18 | herbal_remedy | Herbal Remedy | common | HAS IMAGE |
| 19 | gold_coins | Gold Coins | common | HAS IMAGE |
| 20 | treasure_map | Treasure Map | rare | HAS IMAGE |
| 21 | quest_clue | Mysterious Clue | uncommon | HAS IMAGE |
| 22 | mysterious_letter | Mysterious Letter | uncommon | HAS IMAGE |
| 23 | wolf_pelt | Wolf Pelt | common | HAS IMAGE |
| 24 | wolf_fang | Wolf Fang | common | HAS IMAGE |
| 25 | goblin_ear | Goblin Ear | common | HAS IMAGE |
| 26 | spider_venom | Spider Venom | uncommon | HAS IMAGE |
| 27 | bandit_badge | Bandit Badge | common | HAS IMAGE |
| 28 | map_fragment | Map Fragment | uncommon | HAS IMAGE |
| 29 | mountain_crystal | Mountain Crystal | uncommon | HAS IMAGE |
| 30 | spider_silk | Spider Silk | common | HAS IMAGE |
| 31 | bat_guano | Bat Guano | common | HAS IMAGE |
